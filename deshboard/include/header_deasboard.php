...
<head>
    ...
    <title>Yummy foods | Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index">
                <div class="sidebar-brand-icon">
                    <h1 class="text-white text-capitalize">Yummy<span class="text-danger">.</span></h1>
                    <p style="position:absolute; top:3rem; left:5rem;">Deshboard</p>
                </div>
            </a>
            ...
            <!-- Nav Item - Abouts Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#abouts"
                    aria-expanded="true" aria-controls="abouts">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Abouts</span>
                </a>
                <div id="abouts" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Abouts:</h6>
                        <a class="collapse-item" href="./add_banner.php">Add About</a>
                        <a class="collapse-item" href="./all_banners.php">All Abouts</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Why Choose Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menus"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $_SESSION['auth']['first_name'] ?></span>
                                <img class="img-profile rounded-circle"
                                    src="https://avatars.dicebear.com/api/initials/:<?= $_SESSION['auth']['first_name'] ?>.svg">
                            </a>
